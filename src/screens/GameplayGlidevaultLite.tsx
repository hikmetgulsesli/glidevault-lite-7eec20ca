...
export function GameplayGlidevaultLite({ actions, runtime }: GameplayGlidevaultLiteProps) {
  ...
  return (
    <>
      ...
      <div className="relative w-12 h-12 flex items-center justify-center transform hover:scale-110 transition-transform duration-300 z-20">
      ...
      {/* Start Game Overlay */}
      <div className="absolute inset-0 bg-surface-container-lowest/80 backdrop-blur-sm flex flex-col items-center justify-center z-30 transition-opacity duration-500" id="start-overlay">
      <h2 className="font-headline-lg text-headline-lg text-primary tracking-widest uppercase mb-8 drop-shadow-[0_0_10px_rgba(0,242,255,0.5)]">System Ready</h2>
      ...
      <span className="font-hud-data text-hud-data text-tertiary-fixed-dim glitch-hover drop-shadow-[0_0_5px_rgba(255,186,32,0.4)]">004020</span>
      </div>
      ...
      <span className="font-hud-data text-hud-data text-on-surface opacity-80">140999</span>
      </div>
      </div>
      </div>
      {/* Right: Actions */}
      ...
      <div className="flex-1 bg-primary/80 box-shadow-[0_0_5px_rgba(0,242,255,0.5)]"></div>
      <div className="flex-1 bg-primary/80 box-shadow-[0_0_5px_rgba(0,242,255,0.5)]"></div>
      <div className="flex-1 bg-primary/80 box-shadow-[0_0_5px_rgba(0,242,255,0.5)]"></div>
      <div className="flex-1 bg-primary/20"></div>
      <div className="flex-1 bg-primary/20"></div>
      </div>
      <div className="mt-2 text-right font-hud-data text-hud-data text-primary text-sm">60%</div>
      </div>
      ...
      <span className="font-hud-data text-hud-data text-on-surface">2 / 3</span>
      </div>
      </div>
      </aside>
      ...
      <span className="font-hud-data text-hud-data text-tertiary-fixed-dim text-lg">004020</span>
      </div>
      ...
      <div className="flex-1 bg-primary/80"></div>
      <div className="flex-1 bg-primary/80"></div>
      <div className="flex-1 bg-primary/80"></div>
      <div className="flex-1 bg-primary/20"></div>
      <div className="flex-1 bg-primary/20"></div>
