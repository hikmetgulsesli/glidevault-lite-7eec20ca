...
- GlideVault Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called GlideVault Lite. It should be a full-viewport dodge-and-collect arcade game where the player controls a small glider with keyboard and mouse/touch, avoids moving laser gates, collects glowing vault keys, pauses/resumes, opens settings/help, adjusts difficulty/audio, persis…
...
- Gameplay - GlideVault Lite
- Game Settings - GlideVault Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - GlideVault Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - GlideVault Lite
